...
$("#formulario").submit((e) => {
  ...
  $.post("comprobar_mensajes.php", postData, function (response) {
    ...
    if (x == 991) {
      swal(
        "Error!",
        "Querido usuario, el nombre solo debe contener letras y que este dentro de un rango de 4 a 20 caracteres",
        "error",
      );
    }
    if (x == 992) {
      swal(
        "Error!",
        "Querido usuario, el número de telefono solo debe contener numeros y que este dentro de un rango de 4 a 20 caracteres",
        "error",
      );
    }
    if (x == 993) {
    ...
    if (x == 994) {
      swal(
        "Error!",
        "Querido usuario, el mensaje debe estar de un rango de 10 a 200 caracteres",
        "error",
      );
    }
    if (x == 2525) {
      swal(
        "Error!",
        "Querido usuario, se detectaron palabras groseras, por favor abstenerse a agregar estas palabras",
        "error",
      );
    }
