...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Cell(0, 15, 'Reporte de Solicitudes de Adopción - ASOPATICAS', 0, false, 'C', 0, '', 0, false, 'M', 'M');
...
foreach ($solicitudes as $row) {
    ...
    $html .= "
        ...
        <br><br>
        <p><span class='highlight'>Estado de mascota: </span> Adopción En Proceso </p>
