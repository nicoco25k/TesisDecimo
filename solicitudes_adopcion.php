    ...
    <table id="tablax" class="table table-striped table-bordered">
      ...
      <tbody>
        ...
        foreach ($dbh->query($sql) as $row) {
          ...
          // Botón Confirmar
          echo "<td class='text-center'>";
          echo "<button class='btn btn-success btn-sm' onclick='confirmarAdopcion($id_solicitud_adopcion, this)'>Confirmar</button>";
          echo "</td>";

          // Botón Rechazar
          echo "<td class='text-center'>";
          echo "<button class='btn btn-danger btn-sm' onclick='rechazarAdopcion($id_solicitud_adopcion, this)'>Rechazar</button>";
          echo "</td>";
