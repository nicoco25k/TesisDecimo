            ...
            <div class="align-self-center collapse navbar-collapse flex-fill d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                <div class="flex-fill text-center">
                    <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-active fontanimal" href="noticias.php">Noticias</a>
                        </li>
                        <li class="nav-item">
...
<div class="container-fluid py-3 px-sm-3 px-md-3 bg-pie">
    <div class="row">
        ...
        <div class="col-md-4 d-flex flex-column align-items-center">
            ...
            <a class="mb-2 text-center text-white pt-4 nosubrayar" id="correo asopaticas" href="amigosdeasopaticas@gmail.com">amigosdeasopaticas@gmail.com</a>
