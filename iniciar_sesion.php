...
<h2 style="padding-top: 45px; text-align: center; "><b>Iniciar Sesión</b></h2>
...
<div id="centrar_r">
	...
	<form method="POST" action="asopetssoft.php" class="" id="formulario">
...
<p><a href="recuperar_contra.php" class="r text-muted">Olvide mi contraseña!</a></p>

<!-- Grupo: crear cuenta -->
	

<p class="text-center " style="margin-top: 30px;">¿Aún no tienes una cuenta? <a href="registrar_usuario.php" class=" text-muted">Regístrate ahora!</a></p>
	



<div class="formulario__grupo formulario__grupo-btn-enviar">
    <button type="submit" class="btn btn-success my-2 my-sm-0" >Iniciar Sesión</button>
