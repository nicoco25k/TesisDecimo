...
<body>
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                <div class="flex-fill text-center">
                    <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link fontanimal text-active" href="contactanos.php">Contáctanos</a>
                        </li>
                    </ul>
                </div>
    ...
    <div class="card-body redondear colorfont2 d-flex align-items-center justify-content-between contact-container">
    <!-- Contenedor del logo -->
    <div class="col-sm-4 logo-container">
        <img id="logo_asopaticaspiecontac" src="files/img/logofull.png" alt="Logo Asopaticas">
    ...
    <div class="col-sm-7 text-container">
        <h3 class="text-success text-center py-4">
            <strong>¿Tienes alguna pregunta o quieres más información?</strong>
        </h3>
        <p class="text-success pb-3">
            ¡Estamos aquí para ayudarte! Puedes ponerte en contacto con nosotros a través de:
        </p>
        <p class="text-success mb-1 ">
            <b>Email:</b> <a href="mailto:amigosdeasopaticas@gmail.com" class="text-decoration-none text-success text-container1">amigosdeasopaticas@gmail.com</a>
        </p>
        <p class="text-success">
            <b>Teléfono:</b> <a href="tel:+573023171054" class="text-decoration-none text-success text-container1">+57 302 317 1054</a>
        </p>
    ...
    <div class="row">
        <!-- Refugio Section -->
        <div class="col-md-5 px-md-5 py-3" style="display: block; margin: auto;">
            <div class="card mb-4 product-wap redondear">
                <div class="card-body  redondear colorfont1">
                    <h2 class="text-success text-center"><b>Visita nuestro refugio</b></h2>
                    <div class="mapa py-2">
            ...
            <div class="card mb-4 product-wap redondear">
                <div class="card-body  redondear colorfont1">
                    <form method="POST" action="" id="formulario">
                        ...
                        <!-- Botón Enviar -->
                        <div class="formulario__grupo formulario__grupo-btn-enviar" style="padding-top: 15px;">
