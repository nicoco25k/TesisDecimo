...
<div class="container-fluid py-5">
  ...
  <div class="card shadow-sm" style="border-radius: 10px;">
    <div class="card-body d-flex gap-2 justify-content-center">
      <h2 class="text-center text-muted"><b>INFORMACIÓN SOBRE SOLICITUDES DE ADOPCIONES APROBADAS</b></h2>
  ...
  <div class="container mt-4} tabla-admin-container">
    <table id="tablax" class="table table-striped table-bordered">
      ...
      <tbody>
        <?php
        $sql = "SELECT * FROM bot_solicitud_adopcion WHERE id_estado_adopcion = 3";
  ...
  <div class="card mt-4 shadow-sm" style="border-radius: 10px;">
    <div class="card-body d-flex gap-2 justify-content-center">
      ...
      <button class="btn btn-primary" onclick="generarReporte_aprobadas()">
