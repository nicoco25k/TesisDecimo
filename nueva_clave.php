...
<h2 style="padding-top: 45px; text-align: center; " class="py-5"><b>Restablecer contraseña</b></h2>
...
<label for="emails" class="formulario__label text-center py-3">La nueva contraseña debe contener letras o numeros y debe contar entre 8 a 20 caracteres</label>
	<div class="formulario__grupo-input" >
    Digita tu nueva contraseña
    <input type="password" class="formulario__input" name="password1" id="password1"    placeholder="********" minlength="8" maxlength="20" required>
	</div>
    <br>
    <div class="formulario__grupo-input" >
    Digita de nuevo tu nueva contraseña
